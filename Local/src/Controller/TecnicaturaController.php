...
class TecnicaturaController extends AbstractController
{
    ...
    public function search_tecnicatura(Request $request,TecnicaturaRepository $tecnicaturaRepository):Response{
        $tec = $request->query->get('nombre');        ;
        return $this->render('tecnicatura/index.html.twig', [            
            'tecnicaturas' => $tecnicaturaRepository->findBy(['nombre' => $tec]),
        ]);
