 ...
 */
class getExamenFinalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExamenFinalRepository' shared autowired service.
     *
     * @return \App\Repository\ExamenFinalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExamenFinalRepository.php';

        return $container->privates['App\\Repository\\ExamenFinalRepository'] = new \App\Repository\ExamenFinalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
