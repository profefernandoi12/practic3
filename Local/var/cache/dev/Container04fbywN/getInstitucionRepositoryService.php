 ...
 */
class getInstitucionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InstitucionRepository' shared autowired service.
     *
     * @return \App\Repository\InstitucionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InstitucionRepository.php';

        return $container->privates['App\\Repository\\InstitucionRepository'] = new \App\Repository\InstitucionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
