 ...
 */
class getCursadaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CursadaRepository' shared autowired service.
     *
     * @return \App\Repository\CursadaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CursadaRepository.php';

        return $container->privates['App\\Repository\\CursadaRepository'] = new \App\Repository\CursadaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
