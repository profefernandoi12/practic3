 ...
 */
class getTituloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TituloRepository' shared autowired service.
     *
     * @return \App\Repository\TituloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TituloRepository.php';

        return $container->privates['App\\Repository\\TituloRepository'] = new \App\Repository\TituloRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
