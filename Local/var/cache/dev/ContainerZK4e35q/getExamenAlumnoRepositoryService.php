 ...
 */
class getExamenAlumnoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExamenAlumnoRepository' shared autowired service.
     *
     * @return \App\Repository\ExamenAlumnoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExamenAlumnoRepository.php';

        return $container->privates['App\\Repository\\ExamenAlumnoRepository'] = new \App\Repository\ExamenAlumnoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
