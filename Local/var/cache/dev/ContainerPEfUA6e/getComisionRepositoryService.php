 ...
 */
class getComisionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ComisionRepository' shared autowired service.
     *
     * @return \App\Repository\ComisionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComisionRepository.php';

        return $container->privates['App\\Repository\\ComisionRepository'] = new \App\Repository\ComisionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
