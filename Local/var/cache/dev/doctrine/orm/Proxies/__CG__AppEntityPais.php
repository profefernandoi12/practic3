...
class Pais extends \App\Entity\Pais implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Pais' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Pais' . "\0" . 'descripcion', '' . "\0" . 'App\\Entity\\Pais' . "\0" . 'provincia', '' . "\0" . 'App\\Entity\\Pais' . "\0" . 'persona'];
        }
     ...
     * {@inheritDoc}
     */
    public function getProvincia(): \Doctrine\Common\Collections\Collection
    {
     ...
     * {@inheritDoc}
     */
    public function addProvincium(\App\Entity\Provincia $provincium): static
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addProvincium', [$provincium]);

        return parent::addProvincium($provincium);
    }

    /**
     * {@inheritDoc}
     */
    public function removeProvincium(\App\Entity\Provincia $provincium): static
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeProvincium', [$provincium]);

        return parent::removeProvincium($provincium);
    }
