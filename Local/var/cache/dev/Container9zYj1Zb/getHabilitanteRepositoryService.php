 ...
 */
class getHabilitanteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HabilitanteRepository' shared autowired service.
     *
     * @return \App\Repository\HabilitanteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HabilitanteRepository.php';

        return $container->privates['App\\Repository\\HabilitanteRepository'] = new \App\Repository\HabilitanteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
