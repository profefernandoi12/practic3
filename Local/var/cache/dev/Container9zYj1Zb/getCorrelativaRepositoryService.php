 ...
 */
class getCorrelativaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CorrelativaRepository' shared autowired service.
     *
     * @return \App\Repository\CorrelativaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CorrelativaRepository.php';

        return $container->privates['App\\Repository\\CorrelativaRepository'] = new \App\Repository\CorrelativaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
