 ...
 */
class getRevistaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RevistaRepository' shared autowired service.
     *
     * @return \App\Repository\RevistaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RevistaRepository.php';

        return $container->privates['App\\Repository\\RevistaRepository'] = new \App\Repository\RevistaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
